...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/test/normalize.css') }}">
...
<body>
    <div class="form">
        ...
        <form action="/test/login" method="post" id="form">
    ...
    <script src="{{asset('js/test/ack.js')}}"></script>
    <script src='{{asset('js/test/jquery.min.js')}}'></script>
    <script src="{{asset('js/test/index.js')}}"></script>
</body>

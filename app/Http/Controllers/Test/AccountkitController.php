...
class AccountkitController extends Controller
{
    ...
    public function getData()
    {
        ...
        return view('accountkit.index', compact('phone', 'email', 'userId', 'userAccessToken', 'refreshInterval'));

    }

    public function logout()
    {
        return redirect()->route('accountkit.index');
    }

    public function index()
    {
        return view('accountkit.welcome');
    }
